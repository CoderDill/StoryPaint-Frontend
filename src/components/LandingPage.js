            ...
            <div class="col-lg-4 col-md-6 col-sm-8 col-12">
              <div class="card text-center bg-light bg-opacity-25 mb-4">
                ...
                <div class="card-body bg-light bg-opacity-50">
                  ...
                  <h5 class="card-title">Full Stack Developer</h5>
                  <p class="card-text">
                    Will is a full stack software developer pivoting into the
                    tech indrustry from hospitality management. He has always
                    had a passion for technology and is currently completing his
                    final capstone project at Springboard SEC. He continues to
                    enhance his development skills through collaboration with
